...
const EMPLOYEE = { name: "Store Keeper", role: "Store Keeper • Warehouse" };
...
const StoreAttendanceScreen = () => {
    ...
    const listFooter = (
        <Text style={styles.footerText}>
            SpiceCraft ERP v3.0 • Logged in as Store Keeper (Warehouse)
        </Text>
    );
...
export default StoreAttendanceScreen;
