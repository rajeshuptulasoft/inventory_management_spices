...
const ShiftDashboardScreen = () => {
    ...
    const fetchDashboard = useCallback(async () => {
        try {
            ...
            logScreenApi("ShiftDashboardScreen", "dashboard/production", res, buildUrl("dashboard/production"));
            if (isApiSuccess(res)) {
            ...
            <SafeAreaView style={styles.safeArea} edges={[]}>
                ...
                >
                    <View style={styles.pageHeader}>
                        <Text style={styles.dashboardTitle}>Shift Supervisor Dashboard</Text>
                        <Text style={styles.dashboardSubtitle}>
                            Welcome, Shift Supervisor — Shift Supervisor
                        </Text>
                    </View>
                    ...
                    <View style={styles.panel}>
                        <Text style={styles.panelTitle}>Active Batches in My Shift</Text>
                        {activeBatches.length === 0 ? (
                            <View style={styles.activityEmpty}>
                                <Text style={styles.activityEmptyText}>No active batches in this shift</Text>
                            </View>
                        ) : (
