...
const ShiftProfileScreen = () => {
    ...
    const loadProfile = useCallback(async () => {
        ...
        logScreenApi("ShiftProfileScreen", "auth/profile", res, buildUrl("auth/profile"));
        ...
        setProfile({
            ...
            department: data?.department || "Production & Shift",
...
export default ShiftProfileScreen;
