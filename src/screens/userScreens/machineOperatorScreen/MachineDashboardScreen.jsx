            ...
            <SafeAreaView style={styles.safeArea} edges={[]}>
                ...
                >
                    <View style={styles.pageHeader}>
                        <Text style={styles.dashboardTitle}>Machine Operator Dashboard</Text>
                        <Text style={styles.dashboardSubtitle}>
                            Welcome, Machine Operator — Production Floor
                        </Text>
                    </View>
                    ...
                    <View style={styles.panel}>
                        <Text style={styles.panelTitle}>My Assigned Machines</Text>
                        {activeBatches.length === 0 ? (
                            <View style={styles.activityEmpty}>
                                <Text style={styles.activityEmptyText}>No assigned production runs</Text>
                            </View>
                        ) : (
...
export default MachineDashboardScreen;
