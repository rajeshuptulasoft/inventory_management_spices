...
const ProductionInventoryScreen = () => {
    ...
    return (
        <View style={styles.root}>
            <MyHeader title="Inventory View" onBackPress={navigation.goBack} />
            <SafeAreaView style={styles.safeArea} edges={[]}>
                <FlatList
                    ...
                    ListHeaderComponent={<Text style={styles.pageTitle}>Inventory</Text>}
                    renderItem={({ item }) => (
...
export default ProductionInventoryScreen;
