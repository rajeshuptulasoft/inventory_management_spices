...
const EMPLOYEE = { name: "NSM", role: "National Sales Manager • Sales" };
const STORAGE_KEY = "attendance_nsm";
...
const NsmAttendanceScreen = () => {
    ...
    const listFooter = (
        <Text style={styles.footerText}>
            SpiceCraft ERP v3.0 • Logged in as NSM (National Sales Manager)
        </Text>
    );
...
export default NsmAttendanceScreen;
