...
const NsmProfileScreen = () => {
    ...
    const loadProfile = useCallback(async () => {
        ...
        logScreenApi("NsmProfileScreen", "auth/profile", res, buildUrl("auth/profile"));
        ...
        setProfile({
            ...
            department: data?.department || "National Sales",
...
export default NsmProfileScreen;
