...
const NsmCollectionsScreen = () => {
    ...
    const loadData = useCallback(async () => {
        ...
        logScreenApi("NsmCollectionsScreen", "collections", cRes, buildUrl("collections"));
        logScreenApi("NsmCollectionsScreen", "parties", dRes, buildUrl("parties", "limit=200"));
    ...
    const handleSave = async () => {
        ...
        logScreenApi("NsmCollectionsScreen", "collections/create", res, buildUrl("collections"));
        if (!isApiSuccess(res)) {
...
export default NsmCollectionsScreen;
