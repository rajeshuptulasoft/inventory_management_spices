...
const NsmOrdersScreen = () => {
    ...
    const loadData = useCallback(async () => {
        ...
        logScreenApi("NsmOrdersScreen", "orders", res, buildUrl("orders", "limit=100"));
        if (isApiSuccess(res)) {
            setOrders(
    ...
    return (
        <View style={styles.root}>
            <FinanceHeader title="Orders" profileInitial="N" onProfilePress={navigation.openDrawer} />
...
export default NsmOrdersScreen;
