...
import { useRoleAttendance } from "../../../hooks/useRoleAttendance";
...
const QcAttendanceScreen = () => {
    const navigation = useFinanceNavigation();
    const [search, setSearch] = useState("");
    const [refreshing, setRefreshing] = useState(false);
    const attendanceFeedback = useMemo(
        () => ({
            onCheckIn: (msg) => navigation.showSuccess?.(msg),
            onCheckOut: (msg) => navigation.showSuccess?.(msg),
        }),
        [navigation]
    );
    const { rows, canCheckIn, canCheckOut, handleCheckIn, handleCheckOut, summaryData } =
        useRoleAttendance("QC", attendanceFeedback);
        ...
        <View>
            ...
            <View style={styles.logSection}>
                ...
                <View style={styles.tableHeaderRow}>
                    ...
                    <Text style={[styles.tableHeaderText, styles.colCheck]}>CHECK IN</Text>
                    <Text style={[styles.tableHeaderText, styles.colCheck]}>CHECK OUT</Text>
...
export default QcAttendanceScreen;
