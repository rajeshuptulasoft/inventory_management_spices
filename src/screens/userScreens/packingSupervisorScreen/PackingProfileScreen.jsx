...
const PackingProfileScreen = () => {
    ...
    const loadProfile = useCallback(async () => {
        ...
        logScreenApi("PackingProfileScreen", "auth/profile", res, buildUrl("auth/profile"));
        ...
        setProfile({
            ...
            department: data?.department || "Production Floor",
...
export default PackingProfileScreen;
