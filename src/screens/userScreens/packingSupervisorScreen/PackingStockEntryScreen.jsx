...
const PackingStockEntryScreen = () => {
    ...
    const loadVariants = useCallback(async () => {
        ...
        logScreenApi("PackingStockEntryScreen", "products", res, buildUrl("products", "limit=100"));
        if (isApiSuccess(res)) {
    ...
    const handleSubmit = async () => {
        ...
        logScreenApi("PackingStockEntryScreen", endpoint, res, buildUrl(endpoint));
        if (!isApiSuccess(res)) {
...
export default PackingStockEntryScreen;
