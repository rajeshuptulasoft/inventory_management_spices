...
const PackingCategoriesScreen = () => {
    ...
    const fetchCategories = useCallback(async (isRefresh = false) => {
        ...
        try {
            ...
            logScreenApi("PackingCategoriesScreen", "categories", res, buildUrl("categories"));
            if (!isApiSuccess(res)) {
    ...
    const handleSaveCategory = async (form) => {
        ...
        if (form.id) {
            ...
            logScreenApi("PackingCategoriesScreen", "categories/update", res, buildUrl(`categories/${form.id}`));
        } else {
            res = await POSTNETWORK(buildUrl("categories"), payload, true);
            logScreenApi("PackingCategoriesScreen", "categories/create", res, buildUrl("categories"));
        }
        if (!isApiSuccess(res)) {
        ...
        Alert.alert("Delete Category", `Delete "${item.name}"?`, [
            { text: "Cancel", style: "cancel" },
            {
                ...
                onPress: async () => {
                    ...
                    logScreenApi("PackingCategoriesScreen", "categories/${item.id}", res, buildUrl(`categories/${item.id}`));
                    if (!isApiSuccess(res)) {
...
export default PackingCategoriesScreen;
