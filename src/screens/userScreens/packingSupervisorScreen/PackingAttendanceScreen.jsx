...
const EMPLOYEE = { name: "Packing Supervisor", role: "Packing Supervisor • Production Floor" };
const STORAGE_KEY = "attendance_packing";
...
const PackingAttendanceScreen = () => {
    ...
    const listFooter = (
        <Text style={styles.footerText}>
            SpiceCraft ERP v3.0 • Logged in as Packing Supervisor (Production Floor)
        </Text>
    );
...
export default PackingAttendanceScreen;
