...
const SoSchemesScreen = () => {
    ...
    const loadData = useCallback(async () => {
        ...
        logScreenApi("SoSchemesScreen", "schemes", res, buildUrl("schemes", "limit=100"));
        if (isApiSuccess(res)) {
            setRows(
    ...
    return (
        <View style={styles.root}>
            <FinanceHeader title="Schemes" profileInitial="S" onProfilePress={navigation.openDrawer} />
            <SafeAreaView style={styles.safeArea} edges={[]}>
                <FlatList
                    ...
                    ListHeaderComponent={
                        <View>
                            <Text style={styles.pageTitle}>Trade Schemes</Text>
                            <TextInput
                                style={styles.search}
...
export default SoSchemesScreen;
