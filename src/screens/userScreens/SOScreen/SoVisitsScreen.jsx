...
const SoVisitsScreen = () => {
    ...
    const loadData = useCallback(async () => {
        ...
        logScreenApi("SoVisitsScreen", "sfa", res, buildUrl("sfa", "limit=100"));
        if (isApiSuccess(res)) {
            setRows(
    ...
    return (
        <View style={styles.root}>
            <FinanceHeader title="Visits" profileInitial="S" onProfilePress={navigation.openDrawer} />
