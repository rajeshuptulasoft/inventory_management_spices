...
const SoOrdersScreen = () => {
    ...
    const loadData = useCallback(async () => {
        ...
        logScreenApi("SoOrdersScreen", "orders", res, buildUrl("orders", "limit=100"));
        if (isApiSuccess(res)) {
            setOrders(
    ...
    return (
        <View style={styles.root}>
            <FinanceHeader title="Orders" profileInitial="S" onProfilePress={navigation.openDrawer} />
