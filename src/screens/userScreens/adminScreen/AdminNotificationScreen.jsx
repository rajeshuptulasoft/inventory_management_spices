...
const SCREEN_NAME = "AdminNotificationScreen";
        ...
        <View style={styles.root}>
            ...
            <SafeAreaView style={styles.safeArea} edges={[]}>
                <FlatList
                    ...
                    ListHeaderComponent={<Text style={styles.sectionLabel}>My Notifications</Text>}
                    ListFooterComponent={
...
const styles = StyleSheet.create({
    ...
    sectionLabel: { fontFamily: UBUNTUBOLD, fontSize: 16, color: TEXT_DARK, marginBottom: 12 },
    card: {
        flexDirection: "row",
    ...
    cardTitle: { flex: 1, fontFamily: FIRASANSSEMIBOLD, fontSize: 15, color: TEXT_DARK },
    unreadDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: UNREAD_DOT },
    cardMessage: { fontFamily: FIRASANS, fontSize: 13, color: TEXT_MUTED, lineHeight: 18, marginBottom: 6 },
    cardTime: { fontFamily: FIRASANS, fontSize: 12, color: "#9CA3AF" },
    emptyWrap: { alignItems: "center", paddingVertical: 48 },
    emptyTitle: { fontFamily: FIRASANSSEMIBOLD, fontSize: 16, color: TEXT_DARK, marginBottom: 6 },
