...
const MarketingPrimarySalesScreen = () => {
    ...
    const fetchSales = useCallback(async (isRefresh = false) => {
        ...
        try {
            ...
            logScreenApi("MarketingPrimarySalesScreen", "fmcg/sales-orders", res, buildUrl("fmcg/sales-orders", "limit=100"));
            if (!isApiSuccess(res)) {
    ...
    const handleSaveOrder = async (form) => {
        ...
        logScreenApi("MarketingPrimarySalesScreen", "fmcg/sales-orders", res, buildUrl("fmcg/sales-orders"));
        if (!isApiSuccess(res)) {
