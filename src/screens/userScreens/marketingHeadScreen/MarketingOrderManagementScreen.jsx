...
const OrderCard = ({ item, onView, onEdit }) => (
...
const MarketingOrderManagementScreen = () => {
    ...
    const fetchOrders = useCallback(async (isRefresh = false) => {
        ...
        try {
            ...
            logScreenApi("MarketingOrderManagementScreen", "fmcg/sales-orders", res, buildUrl("fmcg/sales-orders", "limit=100"));
            if (!isApiSuccess(res)) {
    ...
    const handleSaveOrder = async (form) => {
        ...
        logScreenApi("MarketingOrderManagementScreen", "fmcg/sales-orders", res, buildUrl("fmcg/sales-orders"));
        if (!isApiSuccess(res)) {
        ...
        <View style={styles.root}>
            ...
            <SafeAreaView style={styles.safeArea} edges={[]}>
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <OrderCard item={item} onView={handleView} onEdit={handleEdit} />
                    )}
...
export default MarketingOrderManagementScreen;
