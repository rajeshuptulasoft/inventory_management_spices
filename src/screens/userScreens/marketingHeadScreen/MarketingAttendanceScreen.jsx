...
const EMPLOYEE = { name: "Jaydev", role: "Marketing Head" };
const STORAGE_KEY = "attendance_marketing";
...
const MarketingAttendanceScreen = () => {
...
export default MarketingAttendanceScreen;
