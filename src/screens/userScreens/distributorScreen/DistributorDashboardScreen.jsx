...
const DistributorDashboardScreen = () => {
    ...
    const fetchDashboard = useCallback(async () => {
        try {
            ...
            logScreenApi("DistributorDashboardScreen", "finance/dashboard", res, buildUrl("finance/dashboard"));
            if (isApiSuccess(res)) {
            ...
            logScreenApi("DistributorDashboardScreen", "orders", oRes, buildUrl("orders", "limit=100"));
            logScreenApi("DistributorDashboardScreen", "parties", pRes, buildUrl("parties", "limit=200"));
    ...
    return (
        <View style={styles.root}>
            ...
            <SafeAreaView style={styles.safeArea} edges={[]}>
                ...
                >
                    <Text style={styles.title}>Distributor Overview</Text>
...
export default DistributorDashboardScreen;
