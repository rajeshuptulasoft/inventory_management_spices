...
const SCREEN_NAME = "DistributorNotificationScreen";
...
const DistributorNotificationScreen = () => {
    ...
    const fetchNotifications = useCallback(async () => {
        try {
            const res = await GETNETWORK(buildUrl("notifications/mine"), true);
            logScreenApi(SCREEN_NAME, "notifications/mine", res, buildUrl("notifications/mine"));
            if (isApiSuccess(res)) {
...
export default DistributorNotificationScreen;
