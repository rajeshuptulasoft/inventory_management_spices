...
const DistributorSchemesScreen = () => {
    ...
    const loadData = useCallback(async () => {
        ...
        logScreenApi("DistributorSchemesScreen", "schemes", res, buildUrl("schemes"));
        if (isApiSuccess(res)) {
            setRows(
    ...
    return (
        <View style={styles.root}>
            <FinanceHeader title="Schemes" profileInitial="D" onProfilePress={navigation.openDrawer} />
...
export default DistributorSchemesScreen;
