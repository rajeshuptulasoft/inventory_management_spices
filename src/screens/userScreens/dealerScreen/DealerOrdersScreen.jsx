...
const DealerOrdersScreen = () => {
    ...
    const loadData = useCallback(async () => {
        ...
        logScreenApi("DealerOrdersScreen", "orders", res, buildUrl("orders", "limit=100"));
        if (isApiSuccess(res)) {
            setOrders(
    ...
    return (
        <View style={styles.root}>
            <FinanceHeader title="Orders" profileInitial="L" onProfilePress={navigation.openDrawer} />
...
export default DealerOrdersScreen;
