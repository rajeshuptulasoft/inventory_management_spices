...
const DealerProfileScreen = () => {
    ...
    const loadProfile = useCallback(async () => {
        ...
        logScreenApi("DealerProfileScreen", "auth/profile", res, buildUrl("auth/profile"));
        ...
        setProfile({
            ...
            department: data?.department || "Dealer Network",
            joinedOn: data?.created_at?.slice?.(0, 10) || "—",
            initials: name ? name.charAt(0).toUpperCase() : "L",
        });
        setLoading(false);
    }, []);
