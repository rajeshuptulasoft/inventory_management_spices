...
const DealerClaimsScreen = () => {
    ...
    const loadData = useCallback(async () => {
        ...
        logScreenApi("DealerClaimsScreen", "claims", res, buildUrl("claims"));
        if (isApiSuccess(res)) {
    ...
    return (
        <View style={styles.root}>
            <FinanceHeader title="Claims" profileInitial="L" onProfilePress={navigation.openDrawer} />
...
export default DealerClaimsScreen;
