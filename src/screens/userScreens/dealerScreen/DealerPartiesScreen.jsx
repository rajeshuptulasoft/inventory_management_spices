...
const DealerPartiesScreen = () => {
    ...
    const loadData = useCallback(async () => {
        ...
        logScreenApi("DealerPartiesScreen", "parties", res, buildUrl("parties", "limit=200"));
    ...
    return (
        <View style={styles.root}>
            <FinanceHeader title="Parties" profileInitial="L" onProfilePress={navigation.openDrawer} />
...
export default DealerPartiesScreen;
