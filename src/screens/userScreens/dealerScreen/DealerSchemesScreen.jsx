...
const DealerSchemesScreen = () => {
    ...
    const loadData = useCallback(async () => {
        ...
        logScreenApi("DealerSchemesScreen", "schemes", res, buildUrl("schemes"));
        if (isApiSuccess(res)) {
            setRows(
    ...
    return (
        <View style={styles.root}>
            <FinanceHeader title="Schemes" profileInitial="L" onProfilePress={navigation.openDrawer} />
...
export default DealerSchemesScreen;
