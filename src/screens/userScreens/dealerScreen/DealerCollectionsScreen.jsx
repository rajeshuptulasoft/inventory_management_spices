...
const DealerCollectionsScreen = () => {
    ...
    const loadData = useCallback(async () => {
        ...
        logScreenApi("DealerCollectionsScreen", "collections", res, buildUrl("collections"));
        if (isApiSuccess(res)) {
            setRows(
    ...
    return (
        <View style={styles.root}>
            <FinanceHeader title="Collections" profileInitial="L" onProfilePress={navigation.openDrawer} />
...
export default DealerCollectionsScreen;
