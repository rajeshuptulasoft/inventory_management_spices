...
const AddWholesalerModal = ({ visible, editingItem, onClose, onSave }) => {
                    ...
                    <View style={styles.modalCard}>
                        <View style={styles.modalHeader}>
                            <Text style={styles.modalTitle}>
                                {editingItem ? "Edit Wholesaler" : "Add Wholesaler"}
                            </Text>
                            <TouchableOpacity
                                onPress={handleClose}
...
const WholesalerCard = ({ item, onStockLedger, onEdit, onDelete }) => {
    ...
    return (
        <View style={styles.wholesalerCard}>
            ...
            <View style={styles.wholesalerMetaRow}>
...
const SharedWholesalerScreen = () => {
    ...
    const loadData = useCallback(async () => {
        try {
            ...
            setWholesalers(extractApiList(res).map((row) => mapFmcgPartnerRow(row, "WS")));
        } finally {
            setRefreshing(false);
        }
    }, []);
    ...
    const handleSaveWholesaler = async (form) => {
        const payload = {
            name: form.name,
    ...
    const handleDelete = (item) => {
        Alert.alert("Delete Wholesaler", `Delete ${item.name} (${item.code})?`, [
        ...
        <View>
            ...
            <View style={styles.pageHeader}>
                <View style={styles.titleBlock}>
                    <Text style={styles.pageTitle}>Wholesaler Management</Text>
                    <Text style={styles.pageSubtitle}>
                        Wholesaler directory, credit & stock ledger
                    </Text>
                </View>
            </View>
            ...
            <View style={styles.summaryCard}>
                ...
                <Text style={styles.summaryValue}>{wholesalers.length}</Text>
                <Text style={styles.summaryFooter}>→ From database</Text>
            </View>

            <View style={styles.listSection}>
                <Text style={styles.sectionTitle}>Wholesaler Management</Text>
                ...
                <FlatList
                    ...
                    ListEmptyComponent={
                        <View style={styles.emptyWrap}>
                            <Text style={styles.emptyText}>No wholesalers found</Text>
                        </View>
                    }
                />
...
export default SharedWholesalerScreen;
