...
const AddRetailerModal = ({ visible, editingItem, onClose, onSave }) => {
                    ...
                    <View style={styles.modalCard}>
                        <View style={styles.modalHeader}>
                            <Text style={styles.modalTitle}>
                                {editingItem ? "Edit Retailer" : "Add Retailer"}
                            </Text>
                            <TouchableOpacity
                                onPress={handleClose}
...
const RetailerCard = ({ item, onStockLedger, onEdit, onDelete }) => {
...
const SharedRetailerScreen = () => {
    ...
    const loadData = useCallback(async () => {
        try {
            ...
            setRetailers(extractApiList(res).map((row) => mapFmcgPartnerRow(row, "RET")));
        } finally {
            setRefreshing(false);
        }
    }, []);
    ...
    const handleDelete = (item) => {
        Alert.alert("Delete Retailer", `Delete ${item.name} (${item.code})?`, [
        ...
        <View>
            ...
            <View style={styles.pageHeader}>
                <View style={styles.titleBlock}>
                    <Text style={styles.pageTitle}>Retailer Management</Text>
                    <Text style={styles.pageSubtitle}>
                        Outlet master, beat mapping & stock ledger
                    </Text>
                </View>
            </View>
            ...
            <View style={styles.summaryCard}>
                ...
                <Text style={styles.summaryValue}>{retailers.length}</Text>
                <Text style={styles.summaryFooter}>→ From database</Text>
            </View>

            <View style={styles.listSection}>
                <Text style={styles.sectionTitle}>Retailer Management</Text>
...
export default SharedRetailerScreen;
