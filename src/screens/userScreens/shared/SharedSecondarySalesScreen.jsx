...
const SALES_TYPE = "secondary";

const mapOrderToSalesUi = (row) => {
    const base = mapSalesOrderRow(row);
    const rawType = row.order_type || row.type || row.sales_type || "secondary";
    return {
        id: base.id,
...
const NewOrderModal = ({ visible, editingItem, onClose, onSave }) => {
    ...
    useEffect(() => {
        if (visible) {
            ...
            setType(editingItem?.type ?? "Secondary");
...
const SharedSecondarySalesScreen = () => {
    ...
    const listHeader = (
        <View>
            ...
            <View style={styles.pageHeader}>
                <Text style={styles.pageTitle}>Secondary Sales</Text>
                <Text style={styles.pageSubtitle}>Distributor → Retailer sales orders</Text>
            </View>
            ...
            <View style={styles.listSection}>
                <Text style={styles.sectionTitle}>Secondary Sales</Text>
                    ...
                    ListEmptyComponent={
                        !loading ? (
                            <View style={styles.emptyWrap}>
                                <Text style={styles.emptyText}>No secondary sales records found</Text>
                            </View>
                        ) : null
                    }
                />
...
export default SharedSecondarySalesScreen;
