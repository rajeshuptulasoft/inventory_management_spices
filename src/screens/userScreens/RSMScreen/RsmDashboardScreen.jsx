...
const buildSummary = (data = {}) => [
    ...
    },
    {
        ...
        footer: "Regional sales overview",
        icon: "📊",
        iconBg: "#EDE9FE",
...
const RsmDashboardScreen = () => {
    ...
    const fetchDashboard = useCallback(async () => {
        ...
        logScreenApi("RsmDashboardScreen", "analytics/dashboard", res, buildUrl("analytics/dashboard"));
        if (isApiSuccess(res)) {
    ...
    return (
        <View style={styles.root}>
            ...
            <SafeAreaView style={styles.safeArea} edges={[]}>
                ...
                >
                    <Text style={styles.title}>Regional Sales Overview</Text>
