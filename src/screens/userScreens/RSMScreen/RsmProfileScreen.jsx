...
const RsmProfileScreen = () => {
    ...
    const loadProfile = useCallback(async () => {
        ...
        logScreenApi("RsmProfileScreen", "auth/profile", res, buildUrl("auth/profile"));
        ...
        setProfile({
            ...
            department: data?.department || "Regional Sales",
...
export default RsmProfileScreen;
