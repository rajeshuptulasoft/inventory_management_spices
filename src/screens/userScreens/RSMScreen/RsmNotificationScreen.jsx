...
const SCREEN_NAME = "RsmNotificationScreen";
                ...
                <FlatList
                    ...
                    ListFooterComponent={
                        <Text style={styles.footerText}>
                            SpiceCraft ERP v3.0 • Logged in as RSM (Regional Sales Manager)
                        </Text>
                    }
                    ListEmptyComponent={
...
export default RsmNotificationScreen;
